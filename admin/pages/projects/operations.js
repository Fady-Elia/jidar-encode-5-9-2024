...
function getData(rowId)
{
	...
	$.post("get.php", { itemid: rowId,type:2},
                        ...
                        if(data=="nodata")
                        {
                            ...
                            $("#cat_id").val(jsonResponsee['cat_id']);
                          
                            CKEDITOR.instances.detailsar.setData( jsonResponsee['desc_ar'] );
                            CKEDITOR.instances.detailsen.setData( jsonResponsee['desc_en'] );

                            var imgs = jsonResponsee['imgs'].split(",");
                            imgs.forEach(function(img) {

                                $( "#products_imgs" ).append( " <div class='col-lg-2 col-md-2 col-sm-2 col-xs-2 m-b30'> <img width='150px' hight='150px' src="+'../../../uploads/'+img+" > </div>  " );
